return function(config)
	...
	local MODULES = {
		...
		},
		{
			id = "autofocus",
			name = "Autofocus",
			description = "Focuses the window under the pointer so clicks work immediately across monitors.",
			defaultEnabled = true,
			entryPath = PACKAGES_DIR .. "/autofocus/init.lua",
			hotkeys = {},
			secrets = {},
		},
		{
			...
			description = "Copies newly saved native macOS screenshots to the clipboard.",
			defaultEnabled = true,
			entryPath = PACKAGES_DIR .. "/screenshotcopy/init.lua",
			hotkeys = {},
			secrets = {},
		},
		{
